...
public class LoggerFatalExceptionTest extends LoggerFoundationTest {
	...
	public void constractor() {
		...
		LoggerFatalException sut1 = new LoggerFatalException(PROPERTIES_FILE_CAN_NOT_BE_FOUND);
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスは取得できないこと
		LoggerFatalException sut2 = new LoggerFatalException(PROPERTIES_FILE_CAN_NOT_BE_FOUND, "test");
		...
		// 埋め込み文字列が取得できないこと
		// throwクラスは取得できること
		LoggerFatalException sut3 = new LoggerFatalException(PROPERTIES_FILE_CAN_NOT_BE_FOUND, new NullPointerException());
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスが取得できること
		LoggerFatalException sut4 = new LoggerFatalException(PROPERTIES_FILE_CAN_NOT_BE_FOUND, "test", new NullPointerException());
		...
		strList.add("test");
		LoggerFatalException sut5 = new LoggerFatalException(PROPERTIES_FILE_CAN_NOT_BE_FOUND, strList, new NullPointerException());
		...
		LoggerFatalException sut6 = new LoggerFatalException(PROPERTIES_FILE_CAN_NOT_BE_FOUND, strArray, new NullPointerException());
